...
clusters <- c(12, 27, 3, 24) #Selecting cell oligodendrocyte clusters from parent dataset
cellnamesfilter <- c()
...
sro_oligo <- makeSeuratFromSingleCellExperiment(csce)
sro_oligo@data <- logcounts(csce)
